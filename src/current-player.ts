...
/** Updates the icon for the currently active player. */
...
/** Returns the container element for the current player. */
...
/** Checks whether a string is an allowed player color. */
...
/** Returns the matching SVG markup for the active theme. */
...
/** Creates the Code Vibes player icon. */
...
/** Creates the player icon for Gaming, DA and Food. */
...
/** Converts SVG markup into a real SVG element. */
...
/** Reads the first SVG element from a markup string. */
